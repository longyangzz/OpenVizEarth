...
osg::Geometry* OsgData::createLineGrid( const osg::Vec3& vCorner, const osg::Vec3& vWidth, const osg::Vec3& vHeight, float stepSize, const osg::Vec4 & color )
{
    float sLen( vWidth.length() );
    osg::Vec3 sStep( vWidth / sLen * stepSize );
    int sCount( (int)(sLen / stepSize) );

    float tLen( vHeight.length() );
    osg::Vec3 tStep( vHeight / tLen * stepSize );
    int tCount( (int)(tLen / stepSize) );

    osg::Vec3Array* v = new osg::Vec3Array;
    v->reserve( (sCount + 1) * (tCount + 1) * 2 );
    ...
    osg::Vec3 end( vCorner + vHeight );
    for(int mIdx = 0; mIdx<=sCount; mIdx++ )
    {
        osg::Vec3 strut( sStep * mIdx );
        v->push_back( vCorner + strut );
        v->push_back( end + strut );
    }
    end.set( vCorner + vWidth );
    for(int mIdx = 0; mIdx<=tCount; mIdx++ )
    {
...
static unsigned int makeKey( const unsigned short a, const unsigned short b )
{
    if ( a < b )
        return( ( a << 16) | b );
    else
...
static void average3fv( float* r, const float* a, const float* b )
{
    r[0] = (a[0] + b[0]) * .5f;
    r[1] = (a[1] + b[1]) * .5f;
    r[2] = (a[2] + b[2]) * .5f;
...
static bool buildGeodesicSphereData( const float radius, const unsigned int subdivisions, osg::Geometry* geom )
{
...
osg::Geometry* OsgData::makeGeodesicSphere( const float radius, const unsigned int subdivisions, osg::Geometry* geometry )
{
...
static bool buildAltAzSphereData( const float radius, const unsigned int subLat, const unsigned int subLong, osg::Geometry* geom, const bool wire )
{
...
osg::Geometry* OsgData::makeAltAzSphere( const float radius, const unsigned int subLat, const unsigned int subLong, osg::Geometry* geometry )
{
    osg::ref_ptr< osg::Geometry > geom( geometry );
    if( geom == NULL )
        geom = new osg::Geometry;
...
osg::Geometry* OsgData::makeWireAltAzSphere( const float radius, const unsigned int subLat, const unsigned int subLong, osg::Geometry* geometry )
{
    osg::ref_ptr< osg::Geometry > geom( geometry );
    if( geom == NULL )
        geom = new osg::Geometry;
...
osg::Geometry* OsgData::makeWireCircle( const float radius, const unsigned int subdivisions, const osg::Vec3& orientation, osg::Geometry* geometry)
{
    osg::ref_ptr< osg::Geometry > geom( geometry );
    if( geom == NULL )
        geom = new osg::Geometry;
...
osg::Geometry* OsgData::makeCircle( const float radius, const unsigned int subdivisions, const osg::Vec3& orientation, osg::Geometry* geometry)
{
    osg::ref_ptr< osg::Geometry > geom( geometry );
    if( geom == NULL )
        geom = new osg::Geometry;
...
static void addPlaneData( const osg::Vec3& corner,
                          ...
                          const osg::Vec3& normal, osg::Geometry* geom )
{
    ...
    vert->reserve( vert->capacity() + (uSteps + 1) * (vSteps + 1) );
    texc->reserve( texc->capacity() + (uSteps + 1) * (vSteps + 1) );
    norm->reserve( norm->capacity() + (uSteps + 1) * (vSteps + 1) );
...
static bool buildPlaneData( const osg::Vec3& corner, const osg::Vec3& u, const osg::Vec3& v, const osg::Vec2s& subdivisions, osg::Geometry* geom )
{
...
osg::Geometry* OsgData::makePlane( const osg::Vec3& corner, const osg::Vec3& u, const osg::Vec3& v, const osg::Vec2s& subdivisions, osg::Geometry* geometry )
{
    osg::ref_ptr< osg::Geometry > geom( geometry );
    if( geom == NULL )
        geom = new osg::Geometry;
...
static bool buildWirePlaneData( const osg::Vec3& corner, const osg::Vec3& u, const osg::Vec3& v, const osg::Vec2s& subdivisions, osg::Geometry* geom )
{
...
osg::Geometry* OsgData::makeWirePlane( const osg::Vec3& corner, const osg::Vec3& u, const osg::Vec3& v, const osg::Vec2s& subdivisions, osg::Geometry* geometry )
{
    osg::ref_ptr< osg::Geometry > geom( geometry );
    if( geom == NULL )
        geom = new osg::Geometry;
...
static bool buildBoxData( const osg::Vec3& halfExtents, const osg::Vec3s& subdivisions, osg::Geometry* geom )
{
    ...
    geom->setTexCoordArray( 0, new osg::Vec2Array );
    {
        osg::Vec4Array* osgC = new osg::Vec4Array;
        osgC->reserve(1);
        osgC->push_back( osg::Vec4( 1., 0.5, 0.5, .5 ) );
        geom->setColorArray( osgC );
        geom->setColorBinding( osg::Geometry::BIND_OVERALL );
    }
...
osg::Geometry* OsgData::makeBox( const osg::Vec3& halfExtents, const osg::Vec3s& subdivisions, osg::Geometry* geometry )
{
    osg::ref_ptr< osg::Geometry > geom( geometry );
    if( geom == NULL )
        geom = new osg::Geometry;
...
static bool buildWireBoxData( const osg::Vec3& halfExtents, osg::Geometry* geom )
{
...
osg::Geometry* OsgData::makeWireBox( const osg::Vec3& halfExtents, osg::Geometry* geometry )
{
    osg::ref_ptr< osg::Geometry > geom( geometry );
    if( geom == NULL )
        geom = new osg::Geometry;
...
static bool buildArrowData( osg::Geometry* geom )
{
...
osg::Geometry* OsgData::makeArrow( osg::Geometry* geometry )
{
    osg::ref_ptr< osg::Geometry > geom( geometry );
    if( geom == NULL )
        geom = new osg::Geometry;
