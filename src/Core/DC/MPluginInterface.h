 ...
 */
class DC_EXPORT  MPluginInterface: public MouseEventHandler
{
	Q_OBJECT
...
protected:
  ...
  int  _instanceCount;
	...
	// A category name for all drawings done by this MPluginInterface
  QString  _pluginName;
  ...
  QString  _pluginCategory;
	...
	// Root node for all drawings of this MPluginInterface
  ...
  StyleConfig                   _style;
	...
	// Draw root of the currently activated MPluginInterface
...
QT_BEGIN_NAMESPACE
#define PluginInterface_iid "io.tqjxlm.Atlas.MPluginInterface"

Q_DECLARE_INTERFACE(MPluginInterface, PluginInterface_iid)
QT_END_NAMESPACE
